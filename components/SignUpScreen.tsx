  ...
  return (
    <div className="fixed inset-0 w-full h-full overflow-y-auto flex flex-col font-sans z-[60]">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[#065f46]/70 backdrop-blur-[2px]"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col min-h-full">
        ...
        <div className="flex-grow flex items-center justify-center p-6">
          <div className="w-full max-w-[500px] text-center">
            ...
            <p className="text-white/90 text-lg mb-8 font-medium">Join the National Digital Livestock Mission</p>
            ...
            <form onSubmit={handleSignUp} className="space-y-5">
              <div className="text-left space-y-1">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border-2 border-white/60 rounded-xl px-4 py-3 text-white placeholder-white/50 text-xl focus:outline-none focus:border-white focus:bg-white/10 transition-all shadow-inner"
                  disabled={isLoading}
                />
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#cbd5e1] hover:bg-white text-brand-green-950 text-2xl font-bold py-4 rounded-xl shadow-lg transition-all transform active:scale-95 disabled:opacity-50 disabled:scale-100 flex items-center justify-center mt-2"
              >
